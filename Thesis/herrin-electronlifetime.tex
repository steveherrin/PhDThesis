...
The numbers shown in \cref{tab:res_dtau} reflect using only a single electron lifetime measurement. As described below, a number of measurements go into the actual correction applied to data.
