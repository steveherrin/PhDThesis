...
This effect seems to be due to attenuation in the liquid xenon and detector materials. In simulations of a \thorium{228} source at the cathode with infinite electron lifetime, the method reports electron lifetimes of \SI{1.00\pm0.09d4}{\micro\second} measured in both TPCs simultaneously, and \SI{1.23\pm.20d4}{\micro\second} measured in a single TPC, for runs with 2.5k events in the full absorption peak. It reports electron lifetimes of \SI{1.01\pm0.05d4}{\micro\second} measured in both TPCs simultaneously and \SI{1.64\pm0.19d4}{\micro\second} measured in a single TPC, for runs with 5k events in the full absorption peak.

The error due to this effect is small, however. A measured electron lifetime of \SI{2500}{\micro\second} corresponds to a true electron lifetime of roughly \((1/2500-1/15000)^{-1} =\) \SI{3000}{\micro\second}. This will only move the corrected ionization signal 0.8\% higher than its true value, if the ionization drifts over the full \SI{120}{\micro\second} drift time. The effect on the energy resolution in the ionization channel will be half of this this, and even smaller in the rotated spectrum. Since the actual effect depends on the source location and all the detector materials, which are not perfectly simulated, this effect is accepted as a slight worsening in energy resolution, rather than corrected for.
