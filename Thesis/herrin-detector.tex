...
\begin{figure}
\centering
\includegraphics[width=1.0\textwidth]{./photos/detector_cleanroom.png}
\caption[Cutaway view of EXO-200 as installed]{A cutaway view of EXO-200 as installed at WIPP. The TPC vessel is surrounded by cold HFE. A cryostat insulates the HFE and liquid xenon. Lead surrounds the cryostat to shield from external radiation, and a second wall in front of the front-end electronics blocks radiation that might pass through the feedthroughs used for xenon, high voltage, and electrical cabling. All of this is located inside a clean room, which is surrounded with an active muon veto.}
