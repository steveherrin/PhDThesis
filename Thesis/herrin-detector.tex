...
EXO-200 is made out of low-radioactivity copper, and was constructed under a modest concrete overburden to limit cosmogenic activation. The walls only \SI{1.37}{\mm} thick to further reduce backgrounds due to radioactivity in the copper. This necessitates a complex gas-handling system to match the xenon pressure closely with the HFE bath surrounding the vessel.
...
As the name suggests, EXO-200 makes use of \SI{200}{\kg} of xenon enriched to 80.6\% in \xenon{136}. Of the remaining fraction of the xenon, isotope 134 comprises 19.1\%, and lighter natural isotopes are present in trace amounts.\todo{Xenon recirculation, feed/bleed, purifiers, how much xenon is where...}
