...
\Phi = \left(5.15\pm0.05\text{(stat)}^{+0.05}_{-0.06}\text{(sys)}\right)\times10^{-7}\frac{\text{Hz}}{\text{cm}^2}
\end{equation}
and likewise, a vertical flux of
\begin{equation}
\label{eq:muon_vflux_result}
\Phi_v = \left(4.28\pm0.04\text{(stat)}^{+0.04}_{-0.06}\text{(sys)}\right)\times10^{-7}\frac{\text{Hz}}{\text{cm}^2\text{sr}}
\end{equation}
