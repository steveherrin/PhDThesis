...
Comparing this the vertical muon flux to a global fit\cite{Mei:2006qy} suggests the overburden at WIPP is \(1481^{+8}_{-6}\)~\si{\hecto\g\per\square\cm}. Other global fits\cite{Crouch:1987ij}\cite{miyake:1973} yield consistent results to these.
