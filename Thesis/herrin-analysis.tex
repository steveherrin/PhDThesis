...
\caption[KamLAND-Zen spectrum for Majoron-emitting modes]{The energy spectrum reported by KamLAND-Zen. Backgrounds begin to become comparable to the \twonu{} signal below \SI{1}{\MeV}, reducing sensitivity to the Majoron-emitting mode with spectral index 7. (Figure reproduced from \cite{Gando:2012fk}.)}
