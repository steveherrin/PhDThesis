...
\begin{sidewaystable}
\caption[Limits on Majoron-emitting mode half lives and coupling constants]{The half life limits obtained for the various Majoron emitting modes in \xenon{136}. These are also translated into limits on the effective neutrino-Majoron coupling constant \(\langle g_{ee}\rangle\). All limits are at the 90\% confidence level. The model notation follows that of \cite{Bamert:1995fk}.}
\label{tab:analyis_majoron_limits}
\begin{tabular}{l l l c c l l l}\toprule
Model	&	Decay mode	&	Goldstone boson	&	L	&	n	&	Matrix element	&	\(T_{1/2}\) (\si{\year})	&	\(\langle g_{ee}\rangle\)	\\\midrule
IB		&	\zeronuX{}	&	No				&	0	&	1	&	\(M_{F} - M_{GT}\)	&	\(> 6.34\times10^{23}\)	&	\(< (0.5 - 1.0)\times10^{-5}\)	\\
IC		&	\zeronuX{}	&	Yes				&	0	&	1	&	\(M_{F} - M_{GT}\)	&	\(> 6.34\times10^{23}\)	&	\(< (0.5 - 1.0)\times10^{-5}\)	\\
ID		&	\zeronuXX{}	&	No				&	0	&	3	&	\(M_{F\omega^2} - M_{GT\omega^2}\)	&	\(> 6.67\times10^{22}\)	&	\(< 3.3\times10^{-4}\)	\\
IE		&	\zeronuXX{}	&	Yes				&	0	&	3	&	\(M_{F\omega^2} - M_{GT\omega^2}\)	&	\(> 6.67\times10^{22}\)	&	\(< 3.3\times10^{-4}\)	\\
IIB		&	\zeronuX{}	&	No				&	-2	&	1	&	\(M_{F} - M_{GT}\)	&	\(> 6.34\times10^{23}\)	&	\(< (0.5 - 1.0)\times10^{-5}\)	\\
IIC		&	\zeronuX{}	&	Yes				&	-2	&	3	&	\(M_{CR}\)		&	\(> 6.67\times10^{22}\)	&	\(< 2.9\times10^{-4}\)	\\
IID		&	\zeronuXX{}	&	No				&	-1	&	3	&	\(M_{F\omega^2} - M_{GT\omega^2}\)	&	\(> 6.67\times10^{22}\)	&	\(< 3.3\times10^{-4}\)	\\
IIE		&	\zeronuXX{}	&	Yes				&	-1	&	7	&	\(M_{F\omega^2} - M_{GT\omega^2}\)	&	\(> 1.30\times10^{22}\)	&	\(< 2.3\)	\\
IIF		&	\zeronuX{}	&	Gauge boson		&	-2	&	3	&	\(M_{CR}\)		&	\(> 6.67\times10^{22}\)	&	\(< 2.9\times10^{-4}\)	\\
``bulk''	&	\zeronuX{}	&	Bulk field			&	0	&	1	&	\(-\)				&	\(> 2.31\times10^{23}\)	&	\(-\)						\\\bottomrule
\end{tabular}
\end{sidewaystable}
