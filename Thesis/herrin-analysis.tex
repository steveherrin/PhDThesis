...
Suppose a bin for single site data contains \(k\) events in the data. The combined PDF predicts \(n = n(c_\text{norm}, \mathbf{N}, \mathbf{a})\) events. The likelihood function for that individual bin is then given by the Poisson distribution:
\begin{equation}
