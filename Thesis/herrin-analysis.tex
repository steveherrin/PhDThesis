...
\begin{table}
\caption[Limits on Majoron-emitting mode half lives and coupling constants]{The half life limits obtained for the various Majoron emitting modes in \xenon{136} by KamLAND-Zen\cite{Gando:2012fk} and in this work. All limits are at the 90\% confidence level.}
...
\zeronuXpX{}	&	3	&	\(>4.5\times10^{23}\)		&	\(>6.67\times10^{22}\)		\\
