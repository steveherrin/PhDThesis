...
\caption[Nuclear decay structure for \(A=136\)]{Isotopes with \(A=136\). \xenon{136} is an even-even nucleus and is energetically forbidden to beta decay to \isotope{136}{Cs}. Instead, it double beta decays to \isotope{136}{Ba}. \isotope{136}{Ce} should also decay to \isotope{136}{Ba} by double \(\beta^{+}\) decay and double electron capture. However, this has not yet been observed.}
