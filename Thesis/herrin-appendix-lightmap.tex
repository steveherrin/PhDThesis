...
\begin{sidewaysfigure}[tbhp]
\centering
\includegraphics[width=\textwidth]{./plots/lightmap_correction_phi_slices.png}
...
\begin{sidewaysfigure}[tbhp]
\centering
\includegraphics[width=\textwidth]{./plots/lightmap_correction_z_slices.png}
\caption[Correction function \(z\) slices]{The light response function \(f(r,\phi,z)\), evaluated at 13 discrete values of \(z\) over the full range of \(x\) (horizontal axis) and \(y\) (vertical axis).}\label{fig:lightmap_correction_z_slices}
\end{sidewaysfigure}
