...
\end{subfigure}
\caption[Variation of full-absorption peak energies and peak energy ratios over time]{Although the rotated energy of the full-absorption peaks for \isotope{137}{Cs}, \isotope{60}{Co}, and \isotope{228}{Th} vary by about \SI{\pm3}{\percent} over time (top), the ratios between the full-absorption peaks and the \isotope{228}{Th} peak remain much more steady, varying less than \SI{1}{\percent}.}
